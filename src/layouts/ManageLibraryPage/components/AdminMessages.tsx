...
export const AdminMessages = () => {
    ...
    useEffect(() => {
        const fetchUserMessages = async () => {
            if (authState && authState.isAuthenticated) {
                const url = `${import.meta.env.VITE_API_URL}/messages/search/findByClosed?closed=false&page=${currentPage - 1}&size=${messagesPerPage}`;
    ...
    async function submitResponseToQuestion(id: number, response: string) {
        const url = `${import.meta.env.VITE_API_URL}/messages/secure/admin/message`;
